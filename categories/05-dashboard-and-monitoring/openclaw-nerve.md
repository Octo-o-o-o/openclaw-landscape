...
## Key Features
- Voice interaction (12 languages, wake word activation, local Whisper transcription, multi-provider TTS)
- Full workspace visibility (Sub-Agent sessions, workspace files, memory, configuration, tools — all visible and editable)
- Kanban task board (drag-and-drop task management + Agent execution + review workflow + proposal inbox)
- Responsive design (desktop, tablet, and mobile adaptive, touch-friendly)
