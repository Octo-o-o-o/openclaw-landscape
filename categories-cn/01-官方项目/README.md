...
| # | 项目 | Stars | 简介 | 调研 |
|---|------|-------|------|------|
| 1 | [openclaw/openclaw](https://github.com/openclaw/openclaw) | 299,269 | OpenClaw 解决的是 个人 AI 助手的本地化、跨平台、多渠道接入 问题。 | [openclaw-core.md](openclaw-core.md) |
| 2 | [openclaw/clawhub](https://github.com/openclaw/clawhub) | 5,292 | OpenClaw 生态系统面临的核心问题是 Agent 技能（Skills）的分发、版本管理和发现。 | [clawhub.md](clawhub.md) |
| 3 | [openclaw/skills](https://github.com/openclaw/skills) | 2,524 | openclaw/skills 仓库解决的是 技能注册中心的持久化备份和历史存档 问题： | [skills.md](skills.md) |
